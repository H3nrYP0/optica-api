...
class Cliente(db.Model):
    ...
    # Opción 2: Método completo manteniendo el campo 'nombre' como combinado
def to_dict(self):
    data = {
        'id': self.id,
        'nombre': f"{self.nombre} {self.apellido}",  # Nombre completo para compatibilidad
        'primer_nombre': self.nombre,  # <-- Nombre por separado
        'apellido': self.apellido,  # <-- Apellido por separado
        'numero_documento': self.numero_documento,
        'tipo_documento': self.tipo_documento,
