"""
Módulo de ventas: gestión de ventas, detalles, abonos y estados.
Permisos granulares:
- Ventas: ver_ventas, crear_ventas, editar_ventas, eliminar_ventas
- Detalles de venta y abonos: mismos permisos de ventas
- Estados de venta: gestionar_configuracion (o ver_ventas)
"""
